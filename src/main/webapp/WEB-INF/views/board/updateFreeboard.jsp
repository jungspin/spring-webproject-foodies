...
<div class="container" style="margin-bottom: 6vh;">
	<form action="/member/board/updateFreeboard" method="post"
		...
		<div class="form-group">
			<input type="text" class="form-control" id="username" name="username"
				value="${freeBoard.member.username }" readonly="readonly"
				style="background-color: rgb(247, 247, 247); border-radius: 0; margin-bottom: 40px; margin-top: 2vh;">
		</div>
		...
		<div class="form-group">
			<textarea id="content" name="content" id="content"
				...
				style="background-color: rgb(247, 247, 247); border-radius: 0;">${freeBoard.content }</textarea>
		</div>
		...
		<button type="submit" class="input-file-button"
			style="border: none; font-weight: bold;">수정하기</button>
