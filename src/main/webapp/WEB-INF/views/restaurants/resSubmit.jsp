...
<div class="container">
	<form action="/manager/submit" method="post"
		...
		<table class="table table-borderless"
			...
			<div class="form-group">
				...
				<input type="text" class="form-control chk" id="mainTitle"
					placeholder="정확한 상호명을 기재해주세요" name="mainTitle" required="required"
			...
			<div class="form-group">
				...
				<input type="tel" class="form-control chk" id="cntctTel"
					name="cntctTel" required="required"
					style="background-color: rgb(247, 247, 247); border-radius: 0; margin-bottom: 40px; margin-top: 2vh;" />
			</div>
			<div class="form-group">
				<label><span
				...
				<input type="text" class="form-control chk" id="usageDayWeekAndTime"
					...
					placeholder="00:00a.m ~ 00:00a.m 형식으로 입력해주세요"
					style="background-color: rgb(247, 247, 247); border-radius: 0; margin-bottom: 40px; margin-top: 2vh;" />
			</div>
			<div class="form-group">
				<label><span
				...
				<input type="text" class="form-control" name="rprsntvMenu"
					id="rprsntvMenu" placeholder="예) 삼겹살덮밥, 하이라이스.."
					style="background-color: rgb(247, 247, 247); border-radius: 0; margin-bottom: 40px; margin-top: 2vh;" />
			</div>
			<label><span
			...
			<div class="form-group">
				...
				<textarea class="form-control" rows="5" id="itemcntnts"
					name="itemcntnts"
					style="background-color: rgb(247, 247, 247); border-radius: 0; margin-bottom: 10px; margin-top: 2vh;"></textarea>
			</div>
			
		<!-- 	<label class="input-file-button" for="files"
				style="margin-bottom: 80px;">사진업로드</label>
			<div class="form-group" id="fileContainer">
				<input type="file" accept="image/gif, image/jpeg, image/png"
					onchange="fileCheck(this)" class="form-control-file border"
					name="files" id="files" multiple style="display: none;" />
			</div> -->
			...
			<button type="submit" class="input-file-button" id="btn-submit" style="border: none; font-weight: bold; margin-right: 10px">등록하기</button>
